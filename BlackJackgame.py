...
#A function called calculate_score() that takes a List of cards as input 
...
#To Ask the user if they want to restart the game. If they answer yes, clear the console and start a new game.
